...
In reality though, the effect as presented here is likely not going to make your art team very happy. I think you'd likely run into artists wanting to author density texture maps for each object to control how dense the hatching was at every point.
